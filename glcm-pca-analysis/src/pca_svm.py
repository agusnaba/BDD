...
columns_to_keep = ['category'] + [col for col in data.columns if col not in ['number', 'duration', 'Filename','class'] and col != 'category' and col >= 'Dissimilarity']
...
# Highlight and label the two farthest 'good' outliers
good_outliers = good_data.nlargest(2, 'PC1')  # Select two 'good' outliers based on the largest PC1 values
